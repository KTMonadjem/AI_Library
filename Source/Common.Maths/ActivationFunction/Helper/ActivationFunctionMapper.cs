...
public static class ActivationFunctionMapper
{
    ...
    /// <returns></returns>
    public static IActivationFunction MapActivationFunction(
        IActivationFunction.ActivationFunction activationFunction,
        double? alpha = null
    )
    {
        return activationFunction switch
        {
            ...
            IActivationFunction.ActivationFunction.LeakyReLu => new LeakyReLuActivator(
                alpha ?? 0.01
            ),
            ...
            IActivationFunction.ActivationFunction.Softmax => new SoftmaxActivator(),

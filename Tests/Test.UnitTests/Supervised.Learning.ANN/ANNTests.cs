...
namespace Tests.Supervised.Learning.ANN
{
    ...
    public class AnnTests
    {
        ...
        public void Build_Should_Fail_When_NoLayers()
        {
            ...
            act.Should().Throw<InvalidOperationException>().WithMessage("Learning.Supervised.ANN must have layers to build");
        }
        ...
        public void Build_Should_Fail_When_NoInputs()
        {
            ...
            act.Should().Throw<InvalidOperationException>().WithMessage("Learning.Supervised.ANN must have inputs to build");
        }
        ...
        public void ANN_That_HasNotBeenBuilt_Should_NotRun()
        {
            ...
            act.Should().Throw<InvalidOperationException>().WithMessage("Learning.Supervised.ANN must be built before being run");
        }
